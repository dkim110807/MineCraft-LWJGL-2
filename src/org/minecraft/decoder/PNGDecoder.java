...
public final class PNGDecoder {
    ...
    public org.minecraft.decoder.PNGDecoder.Format decideTextureFormat(org.minecraft.decoder.PNGDecoder.Format fmt) {
            ...
            case 0:
                switch(fmt) {
                    ...
                    case ALPHA:
                        return fmt;
                    default:
                        return org.minecraft.decoder.PNGDecoder.Format.LUMINANCE;
                }
            case 1:
            case 5:
            default:
            ...
            case 2:
                switch(fmt) {
                    ...
                    case RGB:
                        return fmt;
                    default:
                        return org.minecraft.decoder.PNGDecoder.Format.RGB;
                }
            case 3:
                switch(fmt) {
                    case ABGR:
                    ...
                    case BGRA:
                        return fmt;
                    default:
                        return org.minecraft.decoder.PNGDecoder.Format.RGBA;
                }
            case 4:
                return org.minecraft.decoder.PNGDecoder.Format.LUMINANCE_ALPHA;
            case 6:
                switch(fmt) {
                    case ABGR:
                    case RGBA:
    ...
    public void decode(ByteBuffer buffer, int stride, org.minecraft.decoder.PNGDecoder.Format fmt) throws IOException {
                    ...
                    case 3:
                        ...
                        switch(fmt) {
                            ...
                            case BGRA:
                                ...
                                break label121;
                            case RGB:
                                this.copyPALtoRGB(buffer, palLine);
                                break label121;
                            default:
                                throw new UnsupportedOperationException("Unsupported format for this image");
                        }
    ...
    public void decodeFlipped(ByteBuffer buffer, int stride, org.minecraft.decoder.PNGDecoder.Format fmt) throws IOException {
        if (stride <= 0) {
