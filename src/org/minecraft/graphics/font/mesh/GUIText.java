...
public final class GUIText {
    ...
    /**
     * The vao id of the meshed text
     */
    private int textMeshVao;

    /**
     * The vertex count of the meshed text
     */
     ...
     */
    private final Vector3f outlineColour = new Vector3f(0f, 0f, 0f);
    ...
    /**
     * Returns the id of the text's vao
     *
    ...
    /**
     * Returns the total number of vertices of all the text's quads
     *
    ...
    /**
     * Returns the font size of the text (a font size of 1 is normal).
     *
    ...
    /**
     * Returns {@code true} if the text should be centered
     *
    ...
    /**
     * Returns the maximaum length of a line of this text.
     *
