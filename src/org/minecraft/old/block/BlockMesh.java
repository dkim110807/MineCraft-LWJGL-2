            ...
            if (!nx) {
                for (int i = 0; i < 6; i++) {
                    vertices.add(new Vertex(new Vector3f(NX_POS[i].x + block.getPosition().x,
                            ...
                            NX_POS[i].z + block.getPosition().z), TCSVector[i + 6], NORMALS[i]));
                }
            }
            ...
            if (!py) {
                for (int i = 0; i < 6; i++) {
                    vertices.add(new Vertex(new Vector3f(PY_POS[i].x + block.getPosition().x,
                            ...
                            PY_POS[i].z + block.getPosition().z), TCSVector[i + 12], NORMALS[i]));
                }
            }
            ...
            if (!ny) {
                for (int i = 0; i < 6; i++) {
                    vertices.add(new Vertex(new Vector3f(NY_POS[i].x + block.getPosition().x,
                            ...
                            NY_POS[i].z + block.getPosition().z), TCSVector[i + 18], NORMALS[i]));
                }
            }
            ...
            if (!pz) {
                for (int i = 0; i < 6; i++) {
                    vertices.add(new Vertex(new Vector3f(PZ_POS[i].x + block.getPosition().x,
                            ...
                            PZ_POS[i].z + block.getPosition().z), TCSVector[i + 24], NORMALS[i]));
                }
            }
            ...
            if (!nz) {
                for (int i = 0; i < 6; i++) {
                    vertices.add(new Vertex(new Vector3f(NZ_POS[i].x + block.getPosition().x,
                            ...
                            NZ_POS[i].z + block.getPosition().z), TCSVector[i + 30], NORMALS[i]));
                }
            }
        }
