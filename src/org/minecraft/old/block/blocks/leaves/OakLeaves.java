package org.minecraft.old.block.blocks.leaves;
...
public class OakLeaves extends Block {
     ...
     * <li>Model with {@link #VERTICES}, {@link #TCS} and {@link #TEXTURE}
     * <p></p>
     *
     * @author 4347
     ...
     * <li>This is same as {@link #OakLeaves(float, float, float, float, float, float)OakLeaves(x, y, z, 0, 0, 0)}
     * <li>This is same as {@link #OakLeaves(float, float, float, Vector3f)OakLeaves(x, y, z, new Vector3f(0, 0, 0))}
     * <li>This is same as {@link #OakLeaves(Vector3f, float, float, float)OakLeaves(new Vector3f(x, y, z), 0, 0, 0)}
     ...
     * @since 1.0
     */
    public OakLeaves(float x, float y, float z) throws IllegalArgumentException, IllegalStateException {
     ...
     * @param y    The y position of the block
     * @param z    The z position of the block
     * @param rotX The x rotation of the block
    ...
    public OakLeaves(float x, float y, float z, @NotNull Vector3f rotation) throws IllegalArgumentException, IllegalStateException {
        super(MODEL, new Vector3f(x, y, z), rotation);
    }

    public OakLeaves(@NotNull Vector3f position, float rotX, float rotY, float rotZ) throws IllegalArgumentException, IllegalStateException {
     ...
     * <li>Use {@link #OakLeaves(BlockModel, Vector3f, Vector3f)} instead
     * <p></p>
     *
     * @param texture  The texture of the block
     * @param position The position of the block
     ...
     * @throws IllegalArgumentException If the y value of the position is lower than 0 or greater than 255
     * @deprecated Use {@link #OakLeaves(BlockModel, Vector3f, Vector3f)} instead
     */
    @Deprecated
     ...
     * <li>This is same as {@link #OakLeaves(BlockModel, Vector3f)OakLeaves(model, new Vector3f(x,y,z))}
     * <li>This is same as {@link #OakLeaves(BlockModel, Vector3f, Vector3f)OakLeaves(model, new Vector3f(x, y, z), new Vector3f(0, 0, 0))}
     * <p></p>
     *
     * @param model The model of this block. Use {@link #MODEL OakLeaves.MODEL} or custom model
     * @param x     The x position of the block
     * @param y     The y position of the block
     * @param z     The z position of the block
     * @throws IllegalArgumentException If the y value of the position is lower than 0 or greater than 255
     ...
     * @see #OakLeaves(BlockModel, Vector3f, Vector3f)
     */
    public OakLeaves(@NotNull BlockModel model, float x, float y, float z) throws IllegalArgumentException, IllegalStateException {
        super(model, new Vector3f(x, y, z));
    }

    public OakLeaves(@NotNull BlockModel model, @NotNull Vector3f position) throws IllegalArgumentException, IllegalStateException {
        super(model, position);
    }
     ...
     * <ul><li>In this case it will return <i>{@link Block.Type#OAK_LEAVES}
     * <p></p>
     *
     * @return The type of this block. Which is <i>{@link Block.Type#OAK_LEAVES}
     * @author 4347
     * @see Block#getType()
     * @see Block.Type
     * @see Block.Type#OAK_LEAVES
     */
    @NotNull
    @Override
     ...
     * <p></p>
     *
     * @return The texture coordinates of this block({@link OakLeaves OAK LEAVES}).
     * @author 4347
     * @see Block#TCS
     * @see #TCS
     */
