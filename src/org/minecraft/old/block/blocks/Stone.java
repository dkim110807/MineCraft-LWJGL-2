package org.minecraft.old.block.blocks;
...
/**
 * <h1>Represents the STONE block</h1>
 *
 * @author 4347
 * @see Block
 */
...
public class Stone extends Block {
    ...
    /**
     * The texture of this block(Stone).
     * <p></p>
     *
     * @see BlockTexture
     * @author 4347
     ...
     * <p></p>
     *
     * @see Block.Type#STONE
     * @author 4347
     */
    private static final Block.Type TYPE = Block.Type.STONE;
    ...
    /**
     * Create a block with the position x,y,z with the default model (Stone.model)
     * <p></p>
     * This is same as Stone(new Vector3f(x,y,z)
     * <p></p>
     *
     ...
     * @see #Stone(Vector3f)
     */
    public Stone(float x, float y, float z) throws IllegalArgumentException {
     ...
     * <p></p>
     * This is same as Stone(model,new Vector3f(x,y,z))
     * <p></p>
     *
     ...
     * @see #Stone(BlockModel, Vector3f)
     */
    public Stone(@NotNull BlockModel model,float x, float y, float z) throws IllegalArgumentException {
        super(model,new Vector3f(x,y,z));
    }
     ...
     * <p>
     * In this case it will return Block.Type.STONE
     * <p></p>
     *
     * @return The type of this block. (Block.Type.STONE)
     * @author 4347
     * @see Block#getType()
     * @see Block.Type
     * @see Block.Type#STONE
